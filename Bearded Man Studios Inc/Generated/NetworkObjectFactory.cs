			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case NetworkCameraNetworkObject.IDENTITY:
						...
						break;
					case ShipMoveNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new ShipMoveNetworkObject(networker, id, frame);
						break;
					case ShootBulletNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new ShootBulletNetworkObject(networker, id, frame);
						break;
					case SpaceMoveNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new SpaceMoveNetworkObject(networker, id, frame);
						break;
